...
![Equation](https://www.codecogs.com/eqnedit.php?latex=\mathbf{x}_{\text{transformed}}&space;=&space;\mathbf{x}&space;\cdot&space;\left(&space;\prod_{k=1}^{N}&space;G_k&space;\right)&space;\cdot&space;R)
